...
def year_wise_total_tweets_plot(data):
...
def year_wise_total_likes_plot(data):
...
def year_wise_total_replies_plot(data):
...
def year_wise_total_retweets_plot(data):
...
def year_wise_total_quotes_plot(data):
